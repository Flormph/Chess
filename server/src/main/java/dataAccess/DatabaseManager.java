...
public class DatabaseManager {
    ...
    public static void createTables() throws DataAccessException {
        try {
            ...
            try (var preparedStatement = conn.prepareStatement("CREATE TABLE IF NOT EXISTS games (gameID int, whiteUsername varchar(128), blackUsername varchar(128), gameName varchar(128), game varchar(10000));")) {
                preparedStatement.executeUpdate();
            }
        } catch (SQLException e) {
            throw new DataAccessException(e.getMessage());
